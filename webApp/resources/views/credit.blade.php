  ...
  <script type="text/javascript">
    ...
    $("#addNew").click(function(){
      ...
      $("#addRow").append('<div class="form-row">'+
        ...
        '<input type="text" class="form-control name" placeholder="Amount example 20,000" name="credit[]">'+
        '<small id="credit_'+length+'_err" class="form-text text-muted"></small></div>'+
