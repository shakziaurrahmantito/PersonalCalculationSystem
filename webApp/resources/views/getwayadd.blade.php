    ...
    <div class="m-2 my-4">
      ...
      <div class="card-body">
          <div style="overflow: hidden;">
            <h3 class="float-left">Getway Add</h3>
  ...
  <script type="text/javascript">
    ...
    $("#addNew").click(function(){
      ...
      $("#addRow").append('<div class="form-row">'+
        ...
        '<input type="text" class="form-control name" placeholder="Example bank" name="name[]">'+
        '<small id="name_'+length+'_err" class="form-text text-muted"></small></div>'+
